...
CREATE TABLE IF NOT EXISTS `SeasonsDivisions` (
  ...
  CONSTRAINT `seasonID` FOREIGN KEY (`seasonID`) REFERENCES `Seasons` (`seasonID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `divisionID` FOREIGN KEY (`divisionID`) REFERENCES `Divisions` (`divisionID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `Adults` (
  ...
  PRIMARY KEY (`adultID`),
  CONSTRAINT `connectedAdult_ID` FOREIGN KEY (`connectedAdultID`) REFERENCES `Adults` (`adultID`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE IF NOT EXISTS `Forms` (
  ...
  CONSTRAINT `seasonDivisionID` FOREIGN KEY (`seasonDivisionID`) REFERENCES `SeasonsDivisions` (`seasonDivisionID`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `registeredPlayerID` FOREIGN KEY (`registeredPlayerID`) REFERENCES `Players` (`playerID`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `registeredAdultID` FOREIGN KEY (`registeredAdultID`) REFERENCES `Adults` (`adultID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
